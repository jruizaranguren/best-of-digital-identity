...
This curated list contains 12 awesome open-source projects with a total of 0 stars grouped into 11 categories. All projects are ranked by a project-quality score, which is calculated based on various metrics automatically collected from GitHub and different package managers.
...
- [Authentication, Oauth2, OIDC, Webauthn](#authentication-oauth2-oidc-webauthn) _0 projects_
- [Access control and authorization](#access-control-and-authorization) _0 projects_
- [Shared Groups](#shared-groups) _11 projects_
- [Cryptographics and Public Key Infrastructure](#cryptographics-and-public-key-infrastructure) _0 projects_
- [Machine Identity Management](#machine-identity-management) _0 projects_
- [Biometrics](#biometrics) _0 projects_
- [Specifications](#specifications) _0 projects_
- [Decentralized Identifiers](#decentralized-identifiers) _0 projects_
- [Self-Sovereign Identity Agents](#self-sovereign-identity-agents) _0 projects_
- [Self-Sovereign Identity, credentials and protocols SDKs](#self-sovereign-identity-credentials-and-protocols-sdks) _1 projects_
