...
This curated list contains 27 awesome open-source projects with a total of 24K stars grouped into 11 categories. All projects are ranked by a project-quality score, which is calculated based on various metrics automatically collected from GitHub and different package managers.
...
- [Identity Providers](#identity-providers) _0 projects_
- [Authentication, Oauth2, OIDC, Webauthn](#authentication-oauth2-oidc-webauthn) _2 projects_
- [Access control and authorization](#access-control-and-authorization) _0 projects_
- [Shared Groups](#shared-groups) _11 projects_
- [Cryptographics and Public Key Infrastructure](#cryptographics-and-public-key-infrastructure) _1 projects_
- [Machine Identity Management](#machine-identity-management) _0 projects_
- [Biometrics](#biometrics) _1 projects_
- [Specifications](#specifications) _0 projects_
- [Decentralized Identifiers](#decentralized-identifiers) _1 projects_
- [Self-Sovereign Identity Agents](#self-sovereign-identity-agents) _3 projects_
- [Self-Sovereign Identity, credentials and protocols SDKs](#self-sovereign-identity-credentials-and-protocols-sdks) _8 projects_
...
<details><summary><b><a href="https://github.com/Laragear/WebAuthn">laragear-webauthn</a></b> (🥈14 ·  ⭐ 400) - Authenticate users with Passkeys: fingerprints, patterns and.. <code><a href="http://bit.ly/34MBwT8">MIT</a></code></summary>

- [GitHub](https://github.com/Laragear/WebAuthn) (👨‍💻 12 · 🔀 44 · ⏱️ 08.05.2026):
